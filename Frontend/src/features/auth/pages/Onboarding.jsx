...
export default function Onboarding() {
  ...
  const onSubmit = async (data) => {
    ...
    const securePassword = data.password || `GoogleAuth@${Math.random().toString(36).slice(-8)}!`;
      ...
      <div className="df-auth-card df-auth-card--wide">
        ...
        <div className="df-auth-card__header">
          <div className="brand-badge brand-badge--google">
            <svg viewBox="0 0 24 24" width="16" height="16" aria-hidden="true" className="google-icon">
              <path
                fill="#4285F4"
